...
export default function ResultMessage({
    ...
    return (
        <div className={clsx(
            ...
            { 'text-danger-800 bg-danger-50': result.status === 'error', 'text-success-800 bg-success-50': result.status === 'success' }
        )}>{result.status === 'success' ? (<FaCheckCircle size={20}></FaCheckCircle>) : (<FaExclamationTriangle size={20}></FaExclamationTriangle>)}
